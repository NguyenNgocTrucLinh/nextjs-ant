import {
    Breadcrumb,Icon,Row,Col,Layout,Card,Carousel,
    Button,Avatar,BackTop,Menu, Dropdown
} from 'antd';
                ...
                <Col span={20}>
                    <Row justify="space-around" type="flex">
                        ...
                        <Col span={12} md={12} xs={0}>
                            <span className="ml-30 float-right"><Icon type="phone" theme="filled" /> Call us 09-090-90909</span>
                        </Col>
                    </Row>
                </Col>
            </Row>
                        ...
                        <Col span={6} md={6} sm={12} xs={24}>
                            ...
                            >
                                <Row>
                                    ...
                                    <Col span={6} md={6} sm={12} xs={24}>
                                        <Button style={{ marginTop: "10px", marginLeft: "10px" }} type="danger">
                            Detail
                                        </Button>
                                    </Col>
                                </Row>
